...
public class Player extends Entities {
    ...
    //MODIFIES: this
    //EFFECTS: sets the default (starting) position and speed for the player. (~middle of the map)
    ...
    //EFFECTS: Checks if player movement results in any collision (with tiles, objects or entities)
    ...
    //EFFECTS: Updates status of items on screen if character interacts (collides) with object. Removes, them from
...
//                    gp.ui.showMessage("You got new boots! Speed+2");
    ...
    //EFFECTS: Handles players interaction with NPC if they collide. Changing gameState to allow for trade.
