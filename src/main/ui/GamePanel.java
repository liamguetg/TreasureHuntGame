...
public class GamePanel extends JPanel implements Runnable {
    ...
    // EFFECTS: Calls the update and repaints functions (to Updates player
    // information and update screen)
    ...
    // double updateInterval = (double) 1000000000 / 20; // 0.0166 seconds/frame (or
    // 60 FPS)
    // double delta = 0;
    // long lastTime = System.nanoTime();
    // long currentTime;
